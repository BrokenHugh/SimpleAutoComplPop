...
" css
if get(g:sacpDefaultFileTypesEnable,'css',0) == 1

	" TODO auto filename completion pop up, for './'  '/' '../'
	autocmd FileType css call sacp#enableForThisBuffer({ "matches": [
...
" html
if get(g:sacpDefaultFileTypesEnable,'html',0) == 1

	" TODO auto filename completion pop up, for './'  '/' '../'
	autocmd FileType html call sacp#enableForThisBuffer({ "matches": [
...
" javascript
if get(g:sacpDefaultFileTypesEnable,'javascript',0) == 1
